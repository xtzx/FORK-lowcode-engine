 ...
 * 负责创建和维护工作区的环境，包括窗口管理、资源管理、插件系统等
 */
import {IDesigner, ILowCodePluginManager, LowCodePluginManager} from '../../designer/src';
import {createModuleEventBus, Editor, IEditor, IEventBus, makeObservable, obx} from '../../editor-core/src';
import {
    IPublicApiPlugins,
    IPublicApiWorkspace,
...
import {ISkeleton} from '../../editor-skeleton/src';
